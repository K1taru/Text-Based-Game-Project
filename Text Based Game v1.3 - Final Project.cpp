...
//Created: 11/10/2023 - 
//Text Based Game v1.3 - Final Project
...
int gameAttempt, checkPoint, cS, HP=100, mainChoice, secondaryChoice, tertiaryChoice;
...
void printAttributes(int HP, int delayTime)
{
	system("CLS");
	cout<<"||||||||||||||||||||||||||||||";
	cout<<"\n   Name: " <<name; 
...
{		//user_is_Playing()
	...
	{		// printDisclaimer()
		...
		system("CLS");
		printString(YELLOW, 3, 800, "< SYSTEM >: " );
		...
		while(checkPoint !=6 ) {	
			...
			{
				case 0:
					printString(WHITE, 25, 1000, "You woke up after loosing consciousness,");
				...
				case 1:
					printString(WHITE, 20, 1000, "This is a test loop for the next scenario");
					exit(0);
					break;
